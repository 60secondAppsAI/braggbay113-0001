  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'bidStartPrice',
          visible: true,
          scopedSlots: { customRender: 'bidStartPrice' },
          sorter: true
          //sorter: (a, b) => a.bidStartPrice - b.bidStartPrice,
          //sorter: (a, b) => a.bidStartPrice.localeCompare(b.bidStartPrice),
        },
      ],
      pagination: {
        current: 1,
