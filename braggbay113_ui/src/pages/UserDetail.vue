						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ContactInfo" type="text" placeholder="Enter ContactInfo" v-model="userToAdd.contactInfo"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Contact Info</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactInfo" type="text" placeholder="Enter ContactInfo" v-model="userDetails.contactInfo"></input>
																		</div>
						</td>
														</tr>
